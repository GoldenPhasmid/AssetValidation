...
#define DEFINE_EDIT_CONDITION_NODE(TYPE, ...) \
	namespace UE::AssetValidation { struct TYPE { static const TCHAR* const Moniker; }; } \
	DEFINE_EXPRESSION_NODE_TYPE(UE::AssetValidation::TYPE, __VA_ARGS__)
	...
	DEFINE_EXPRESSION_NODE_TYPE(UE::AssetValidation::FPropertyToken, 0x9A3FAF6F, 0xB2E45E4D, 0xA80A70C6, 0x47A89BD7)
	DEFINE_EXPRESSION_NODE_TYPE(UE::AssetValidation::FEnumToken, 0xC9A35C24, 0x21FC904B, 0x9F1B2B6A, 0xDF6F4BC4)
	DEFINE_EXPRESSION_NODE_TYPE(UE::AssetValidation::FNullPtrToken, 0xC3E91735, 0xB3B90C4D, 0x99BA3DCA, 0xC6CC6231)
	DEFINE_EXPRESSION_NODE_TYPE(UE::AssetValidation::FIndexNoneToken, 0x6A9CA107, 0x8ED649E4, 0xAF4525CA, 0xEBF84F97)
